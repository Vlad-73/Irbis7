                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type=text name=search[email] value="{$aSearch.email|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <select name="search[has_customer]" class="form-control btn-sm">
                                    <option value='1' {if $aSearch.has_customer=='1' } selected {/if}>{$oLanguage->getDMessage('Yes')}</option>
                                    <option value='0' {if $aSearch.has_customer=='0' } selected {/if}>{$oLanguage->getDMessage('No')}</option>
                                    <option value='' {if $aSearch.has_customer=='' } selected {/if}>{$oLanguage->getDMessage('Ignore')}</option>
                                </select>
                            </div>
                        </div>
                    </div>
