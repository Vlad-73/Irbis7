...
<tr>
 ...
 {$oLanguage->getDMessage('Brand')} [{$aCat.title}] {$oLanguage->getDMessage('pref')} [{$aCat.pref}] id_sup [{$aCat.id_sup}] id_mfa [{$aCat.id_mfa}]{$oLanguage->getDMessage('price_item')} [{$iCntPrice}]
 </th>
</tr>
<tr><td>
