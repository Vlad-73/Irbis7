            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('zzz_code')}:</label>
                                <input type=text name=search[zzz_code] value="{$aSearch.zzz_code|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('old_price')}:</label>
                                <input type=text name=search[old_price] value="{$aSearch.old_price|escape}" maxlength=50 class="form-control btn-sm">
                            </div>

                        </div>
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('bage')}:</label>
                                <input type=text name=search[bage] value="{$aSearch.bage|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
