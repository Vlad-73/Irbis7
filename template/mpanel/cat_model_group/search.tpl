            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->getDMessage('id models')}:</label>
                                <input type=text name=search[id_models] value="{$aSearch.id_models|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
