	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="col-sm">
				    <div class="form-group">
				        <label>{$oLanguage->getDMessage('id sup')}:</label>
				        <input type=text name=search[id_sup] value="{$aSearch.id_sup|escape}" maxlength=50 class="form-control btn-sm">
				    </div>
				...
				<div class="col-sm">
				    <div class="form-group">
				        ...
				        <input type=text name=search[id_mfa] value="{$aSearch.id_mfa|escape}" maxlength=50 class="form-control btn-sm">
				    </div>
