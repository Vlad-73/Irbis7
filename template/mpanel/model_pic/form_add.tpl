	...
	<tr>
		...
		<table cellspacing=2 cellpadding=1>
			<tr>
				...
				<td><select name="data[id_mfa]" id="id_mfa" class="searcher_select"
	        onchange="javascript:
				xajax_process_browse_url('?action=model_pic_make&data[id_mfa]='+this.options[this.selectedIndex].value);
	 			return false;">
			{html_options options=$aMakeTof selected=$aData.id_mfa style='width:220px'}
	        </select></td>
			</tr>
			<tr>
