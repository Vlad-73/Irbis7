                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->getDMessage('amount')}:</label>
                                <input type=text name=search[amount] value="{$aSearch.amount|escape}" maxlength=50 class="form-control btn-sm">
                            </div>

                        </div>
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->getDMessage('discount')}:</label>
                                <input type=text name=search[discount] value="{$aSearch.discount|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
