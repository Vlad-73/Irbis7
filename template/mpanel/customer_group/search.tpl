            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('Group discount')}:</label>
                                <input type=text name=search[group_discount] value="{$aSearch.group_discount|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type=text name=search[hours_expired_cart] value="{$aSearch.hours_expired_cart|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
