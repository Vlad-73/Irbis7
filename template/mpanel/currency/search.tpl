            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('CurrencyName')}:</label>
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type=text name=search[symbol] value="{$aSearch.symbol|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type=text name=search[num] value="{$aSearch.num|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
