...
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			...
			<input type=text name=data[password] value='{$aData.password}'  class="form-control btn-sm">
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			...
			<input type=text name=data[retype_password] value='{$aData.retype_password}'  class="form-control btn-sm">
		</div>
	</div>
</div>
