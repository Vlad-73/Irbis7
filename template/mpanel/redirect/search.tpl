            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('link from')}:</label>
                                <input type=text name=search[link_from] value="{$aSearch.link_from|escape}" maxlength=50 class="form-control btn-sm">
                            </div>

                        </div>
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('link to')}:</label>
                                <input type=text name=search[link_to] value="{$aSearch.link_to|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
