                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type=text name=search[action_name] value="{$aSearch.action_name|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <select name="search[is_exeption]" class="form-control btn-sm">
                                    <option value='1' {if $aSearch.is_exeption=='1' } selected {/if}>{$oLanguage->getDMessage('Yes')}</option>
                                    <option value='0' {if $aSearch.is_exeption=='0' } selected {/if}>{$oLanguage->getDMessage('No')}</option>
                                    <option value='' {if $aSearch.is_exeption=='' } selected {/if}>{$oLanguage->getDMessage('Ignore')}</option>
                                </select>
                            </div>
                        </div>
                    </div>
