  ...
  <ul class="nav nav-pills nav-sidebar flex-column nav-compact text-sm nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item has-treeview">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link" onclick="doAction(this, 'redirect');">
            <i class="fas fa-file-signature nav-icon"></i><p>{$oLanguage->GetDMessage('Redirects')}</p></a>
        </li>
      </ul>
    </li>
	...
	<li class="nav-item has-treeview">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link" onclick="doAction(this, 'cat_cross');">
          <i class="fas fa-car-side nav-icon"></i><p>{$oLanguage->GetDMessage('cross')}</p></a>
        </li>

        <li class="nav-item">
          <a href="#" class="nav-link" onclick="doAction(this, 'cat_cross_stop');">
          <i class="fas fa-car-side nav-icon"></i><p>{$oLanguage->GetDMessage('cross_stop')}</p></a>
        </li>
        ...
        <li class="nav-item">
          <a href="#" class="nav-link" onclick="doAction(this, 'tecdoc_filter');">
            <i class="fas fa-car-side nav-icon"></i><p>{$oLanguage->GetDMessage('TecDoc Filter')}</p></a>
        </li>
