            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->getDMessage('last login')}:</label>
                                <input type=text name=search[last_login] value="{$aSearch.last_login|escape}" maxlength=50 class="form-control btn-sm">
                            </div>

                        </div>
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->getDMessage('Last referer')}:</label>
                                <input type=text name=search[last_referer] value="{$aSearch.last_referer|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type=text name=search[is_base_denied] value="{$aSearch.is_base_denied|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
