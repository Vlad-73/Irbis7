            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->GetdMessage('limit_count')}:</label>
                                <input type=text name=search[limit_count] value="{$aSearch.limit_count|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type=text name=search[filename] value="{$aSearch.filename|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
