            ...
            <form id="filter_form" name="filter_form" role="form" action="javascript:void(null)" onsubmit="submit_form(this)">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <label>{$oLanguage->getDMessage('Group Margin')}:</label>
                                <input type=text name=search[group_margin] value="{$aSearch.group_margin|escape}" maxlength=50 class="form-control btn-sm">
                            </div>
