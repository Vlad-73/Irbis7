...
{assign var="sBaseUpload" value="upload_xls"}
...
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			...
			<a href=# onclick="ShowFileUpload('{$sBaseUpload}',false)" style='font-weight:normal'>{$oLanguage->getDMessage('Clear')}</a></td>
		</div>
	</div>
</div>
...
<!-- /.card-body -->
		    <div class="card-footer">
				...
				{include file='addon/mpanel/base_add_button.tpl' sBaseAction=cat_cross_stop_import}
		   </div>
		   <!-- /.card-footer -->
		   </form>
